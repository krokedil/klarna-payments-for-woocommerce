<?php
/**
 * Plugin Name: KP Tests, WooCommerce session upsert
...
add_action(
    ...
    static function (): void {
        ...
        try {
            ...
            $exists = $sqlite
                ->query("SELECT name FROM sqlite_master WHERE type = 'index' AND name = 'kp_tests_session_key'")
                ->fetchColumn();
            ...
            $sqlite->exec("CREATE UNIQUE INDEX kp_tests_session_key ON `{$table}` (session_key)");
        } catch (Throwable $e) {
