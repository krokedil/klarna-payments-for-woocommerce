...
/**
 * Pins an outgoing Klarna request against a committed JSON fixture.
 *
...
trait CanSnapshotRequests {
	 ...
	 *
	 * @param array                 $request      A request from klarnaRequestTo().
	...
	private function maskSnapshotValues( string $text, array $placeholders ): string {
		...
		// The Klarna host stays intact; the regional endpoint is part of what is pinned.
