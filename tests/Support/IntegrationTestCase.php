...
abstract class IntegrationTestCase extends WPTestCase {
	...
	/**
	 * Puts the Klarna traffic this test provoked into the test report, pass or fail —
	 * a green report doubles as a record of what KP actually sends.
	 */
	...
	/**
	 * The first Klarna order line of the given type, e.g. `physical` or `shipping_fee`.
	 */
	...
	/**
	 * Asserts that a Klarna order line of the given type exists, and returns it.
	 */
