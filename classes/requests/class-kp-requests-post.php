...
abstract class KP_Requests_Post extends KP_Requests {
	...
	protected function get_body() {
		...
		$customer_type = kp_get_maybe_filtered_customer_type( $this->arguments['customer_type'] ?? get_option( 'woocommerce_klarna_payments_settings', array( 'customer_type' => 'b2c' ) )['customer_type'] );
