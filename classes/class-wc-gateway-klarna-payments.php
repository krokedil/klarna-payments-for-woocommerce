...
class WC_Gateway_Klarna_Payments extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->pay_button_id = Krokedil\Klarna\KlarnaExpressCheckout::get_payment_button_id();
	...
	public function process_payment( $order_id ) {
		...
		if ( 'redirect' === $checkout_flow ) {
			...
			$kec_client_token = Krokedil\Klarna\KlarnaExpressCheckout\Session::get_client_token();
