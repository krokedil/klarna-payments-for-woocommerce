...
use KrokedilKlarnaPaymentsDeps\Krokedil\Klarna\OrderManagement\KlarnaOrderManagement;
 ...
 */
define( 'WC_KLARNA_PAYMENTS_VERSION', '4.6.1' );
...
if ( ! class_exists( 'WC_Klarna_Payments' ) ) {
	...
	class WC_Klarna_Payments {
		...
		public function order_management_check() {
			if ( ! class_exists( 'WC_Klarna_Order_Management' ) && ! class_exists( 'KrokedilKlarnaPaymentsDeps\Krokedil\Klarna\OrderManagement\KlarnaOrderManagement' ) ) {
