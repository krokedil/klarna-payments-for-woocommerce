 ...
 */
define( 'WC_KLARNA_PAYMENTS_VERSION', '4.1.1' );
...
if ( ! class_exists( 'WC_Klarna_Payments' ) ) {
	...
	class WC_Klarna_Payments {
		...
		public function include_files() {
			...
			include_once WC_KLARNA_PAYMENTS_PLUGIN_PATH . '/classes/payment-processors/class-kp-payment-processor.php';
			include_once WC_KLARNA_PAYMENTS_PLUGIN_PATH . '/classes/payment-processors/class-kp-payment-processor-hpp.php';
			include_once WC_KLARNA_PAYMENTS_PLUGIN_PATH . '/classes/payment-processors/class-kp-payment-processor-kec.php';
			include_once WC_KLARNA_PAYMENTS_PLUGIN_PATH . '/classes/payment-processors/class-kp-payment-processor-kp.php';
