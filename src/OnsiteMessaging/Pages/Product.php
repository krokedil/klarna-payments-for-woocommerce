 ...
 * @internal
 */
class Product extends \Krokedil\Klarna\OnsiteMessaging\Pages\Page
{
    /**
     ...
     * @var array
     */
    protected $properties = array('theme' => 'onsite_messaging_theme_product', 'key' => 'placement_data_key_product', 'client_id' => 'data_client_id', 'placement_id' => 'placement_data_key_product', 'priority' => 'onsite_messaging_product_location', 'custom_widget_enabled' => 'custom_product_page_widget_enabled', 'custom_widget_target' => 'custom_product_page_placement_hook', 'custom_widget_priority' => 'custom_product_page_placement_priority');
    /**
     * Class constructor.
     *
