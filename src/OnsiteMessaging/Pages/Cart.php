 ...
 * @internal
 */
class Cart extends \Krokedil\Klarna\OnsiteMessaging\Pages\Page
{
    /**
     ...
     * @var array
     */
    protected $properties = array('theme' => 'onsite_messaging_theme_cart', 'key' => 'placement_data_key_cart', 'client_id' => 'data_client_id', 'placement_id' => 'placement_data_key_cart', 'target' => 'onsite_messaging_cart_location');
    /**
     * Class constructor.
     *
    ...
    {
        ?>
			<input type="hidden" id="kosm_cart_total" name="kosm_cart_total" value="<?php 
        echo \esc_html(\WC()->cart->get_total('kosm'));
        ?>">
		<?php 
    }
}
