...
class Shortcode
{
    ...
    public function shortcode_output($atts)
    {
        ...
        if (!\is_admin()) {
            ...
            $atts = \shortcode_atts(array('data-key' => 'homepage-promotion-wide', 'data-theme' => '', 'data-purchase-amount' => ''), $atts);
            \ob_start();
            \Krokedil\Klarna\OnsiteMessaging\Utility::print_placement($atts);
            $html = \ob_get_clean();
        }
        return $html;
    }
