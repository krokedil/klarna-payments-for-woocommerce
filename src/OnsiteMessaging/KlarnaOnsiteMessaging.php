...
class KlarnaOnsiteMessaging
{
    ...
    {
        $this->settings = new \Krokedil\Klarna\OnsiteMessaging\Settings($settings);
    ...
    public function init()
    {
        ...
        $this->shortcode = new \Krokedil\Klarna\OnsiteMessaging\Shortcode();
    ...
    {
        \register_widget(new \Krokedil\Klarna\OnsiteMessaging\Widget($this));
    }
    /**
