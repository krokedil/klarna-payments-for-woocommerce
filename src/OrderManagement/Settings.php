...
class Settings {
	...
	public function extend_settings( $settings ) {
		...
		$settings['kom_auto_capture'] = array(
			...
			'label'   => __( 'Activate Klarna order automatically when WooCommerce order is marked complete.', 'klarna-order-management' ),
		);
		...
		$settings['kom_auto_cancel'] = array(
			...
			'label'   => __( 'Cancel Klarna order automatically when WooCommerce order is marked canceled.', 'klarna-order-management' ),
		);
		...
		$settings['kom_auto_update'] = array(
			...
			'label'   => __( 'Update Klarna order automatically when WooCommerce order is updated.', 'klarna-order-management' ),
		);
		...
		$settings['kom_auto_order_sync'] = array(
			...
			'label'   => __( 'Gets the customer information from Klarna when creating a manual admin order and adding a Klarna order id as a transaction id.', 'klarna-order-management' ),
		);
		...
		$settings['kom_force_full_capture'] = array(
			...
			'label'   => __( 'Force capture full order. Useful if the Klarna order has been updated by an ERP system.', 'klarna-order-management' ),
		);
		...
		$settings['kom_debug_log'] = array(
			...
			'label'   => __( 'Enable the debug log.', 'klarna-order-management' ),
		);
